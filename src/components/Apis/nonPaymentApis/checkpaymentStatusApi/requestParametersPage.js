...
export class requestParametersPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      description: Data.Apis.nonPaymentApis.checkpaymentStatusApi.requestParameters.description,
      fieldName: Data.Apis.nonPaymentApis.checkpaymentStatusApi.requestParameters.fieldName
    }
  }
  check(data) {
    if (data.length > 0) {
