...
export class responseParametersPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      description: Data.Apis.nonPaymentApis.checkpaymentStatusApi.responseParameters.description,
      fieldName: Data.Apis.nonPaymentApis.checkpaymentStatusApi.responseParameters.fieldName
    }
  }
  check(data) {
    if (data.length > 0) {
