...
export class responseParametersPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      description: Data.Apis.nonPaymentApis.fetchtransactionaldetails.responseParameters.description,
      fieldName: Data.Apis.nonPaymentApis.fetchtransactionaldetails.responseParameters.fieldName
    }
  }
  check(data) {
    if (data.length > 0) {
