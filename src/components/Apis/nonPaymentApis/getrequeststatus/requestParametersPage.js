...
export class requestParametersPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      description: Data.Apis.nonPaymentApis.getrequeststatus.requestParameters.description,
      fieldName: Data.Apis.nonPaymentApis.getrequeststatus.requestParameters.fieldName
    }
  }
  check(data) {
    if (data.length > 0) {
