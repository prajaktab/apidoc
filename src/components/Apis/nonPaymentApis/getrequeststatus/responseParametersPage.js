...
export class responseParametersPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      description: Data.Apis.nonPaymentApis.getrequeststatus.responseParameters.description,
      fieldName: Data.Apis.nonPaymentApis.getrequeststatus.responseParameters.fieldName
    }
  }
  check(data) {
    if (data.length > 0) {
