...
export class requestParametersPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      description: Data.Apis.nonPaymentApis.gettodaysdata.requestParameters.description,
      fieldName: Data.Apis.nonPaymentApis.gettodaysdata.requestParameters.fieldName
    }
  }
  check(data) {
    if (data.length > 0) {
