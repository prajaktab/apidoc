...
export class responseParametersPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      description: Data.Apis.nonPaymentApis.gettodaysdata.responseParameters.description,
      fieldName: Data.Apis.nonPaymentApis.gettodaysdata.responseParameters.fieldName
    }
  }
  check(data) {
    if (data.length > 0) {
