...
export class requestParametersPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      description: Data.Apis.nonPaymentApis.gettransactiondetails.requestParameters.description,
      fieldName: Data.Apis.nonPaymentApis.gettransactiondetails.requestParameters.fieldName
    }
  }
  check(data) {
    if (data.length > 0) {
