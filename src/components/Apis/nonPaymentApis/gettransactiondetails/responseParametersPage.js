...
export class responseParametersPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      description: Data.Apis.nonPaymentApis.gettransactiondetails.responseParameters.description,
      fieldName: Data.Apis.nonPaymentApis.gettransactiondetails.responseParameters.fieldName
    }
  }
  check(data) {
    if (data.length > 0) {
