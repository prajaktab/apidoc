...
export class requestParametersPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      description: Data.Apis.nonPaymentApis.statusquery.requestParameters.description,
      fieldName: Data.Apis.nonPaymentApis.statusquery.requestParameters.fieldName
    }
  }
  check(data) {
    if (data.length > 0) {
