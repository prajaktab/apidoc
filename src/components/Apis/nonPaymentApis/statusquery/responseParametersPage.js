...
export class responseParametersPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      description: Data.Apis.nonPaymentApis.statusquery.responseParameters.description,
      fieldName: Data.Apis.nonPaymentApis.statusquery.responseParameters.fieldName
    }
  }
  check(data) {
    if (data.length > 0) {
